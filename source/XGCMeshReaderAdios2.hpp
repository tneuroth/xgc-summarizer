...
inline void getNeighborhoods( TN::SummaryGrid2< ValueType > & summaryGrid )
{
...
inline void readMeshBP(
    TN::SummaryGrid2< ValueType > & summaryGrid,
    ...
    const std::string & bpath )
{
    ...
    if( rz )
    {
        ...
        meshReader.Get( rz, tmp, adios2::Mode::Sync );
    }
    else
    {
        std::cerr << "couldn't find rz" << std::endl;
    }
    ...
    adios2::IO bfieldIO = adios.DeclareIO( "BField-IO" );
